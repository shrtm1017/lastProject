	...
	<div class="col-sm-4">
	    <div class="page-header float-left" id="page-title-style">
	        <div class="page-title">
	            <h1 style="padding-bottom: 0px;"><strong>명함 수정</strong></h1>
	        </div>
	    </div>
	</div>
</div>
...
<div>
	<div class="col-lg-12 col-sm-4"> <br>
		<form id="frm" action="${cp}/cardModify" method="post">
			<div class="form-group">
				<div class="col col-md-2"></div>
				<div class="col col-md-8">
					<input type="hidden" name="cal_sq" value="${cal_sq}">
					<div class="card">
						<div class="card-body card-block">
							<div class="form-group">
								...
								<input type="text" id="cal_nm" name="cal_nm" placeholder="이름"
									class="form-control" value="${callingcardVo.cal_nm}">
							</div>
							<div class="form-group">
								<label for="cal_grade" class=" form-control-label"><strong>직책(직급)</strong></label>
								<input type="text" id="cal_grade" name="cal_grade" placeholder="직책(직급)"
									class="form-control" value="${callingcardVo.cal_grade}">
							</div>
							<div class="form-group">
								<label for="cal_com" class=" form-control-label"><strong>회사명</strong></label>
								<input type="text" id="cal_com" name="cal_com" placeholder="회사명"
									class="form-control" value="${callingcardVo.cal_com}">
							</div>
							<div class="form-group">
								<label for="cal_phone" class=" form-control-label"><strong>휴대폰 번호</strong></label>
								<input type="text" id="cal_phone" name="cal_phone" placeholder="휴대폰 번호"
									class="form-control" value="${callingcardVo.cal_phone}">
							</div>
							<div class="form-group">
								<label for="cal_com_phone" class=" form-control-label"><strong>회사 전화번호</strong></label>
								<input type="text" id="cal_com_phone" name="cal_com_phone"
									placeholder="회사 전화번호" class="form-control" value="${callingcardVo.cal_com_phone}">
							</div>
							<div class="form-group">
								<label for="cal_mail" class=" form-control-label"><strong>이메일</strong></label>
								<input type="text" id="cal_mail" name="cal_mail" placeholder="이메일"
									class="form-control" value="${callingcardVo.cal_mail}">
							</div>
							<div class="form-group">
							...
							<div class="form-group text-center">
								<button id="btnUp" type="submit" class="btn btn-primary btn-sm col-sm-2">저장</button>
