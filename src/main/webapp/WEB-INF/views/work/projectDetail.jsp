	...
	<div class="col-sm-4">
		<div class="page-header float-left" id="page-title-style">
	        <div class="page-title">
	            <h1 style="padding-bottom: 0px;"><strong>${sessionScope.projectVo.pro_nm}</strong></h1>
			</div>
		</div>
	</div>
</div>

<form id="frm" action="${cp}/projectConditionSelect" method="get">
	            ...
	            <div class="custom-tab">
	                ...
	                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
	                    <div class="tab-pane fade <c:if test="${tabpaneCode == '1'}">active show</c:if>" id="custom-nav-project" role="tabpanel">
	                        <div class="col col-md-12">
								<div class="col col-md-6">
									<table id="" class="table text-center" role="grid" aria-describedby="bootstrap-data-table_info">
										<thead>
											<tr role="row">
												<th></th>
												<th>진행중</th>
										...
										<tbody>
											<tr role="row">
												<th>새기능</th>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=1&selectCondition=&selectTypeState=1&selectType=새기능&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.NEW_ING}
													</a>
												</td>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=2&selectCondition=&selectTypeState=1&selectType=새기능&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.NEW_FIN}
													</a>
												</td>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=3&selectCondition=&selectTypeState=1&selectType=새기능&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.NEW_SUM}
													</a>
												</td>
											</tr>
											<tr role="row">
												<th>결함</th>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=1&selectCondition=&selectTypeState=1&selectType=결함&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.DEFECT_ING}
													</a>
												</td>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=2&selectCondition=&selectTypeState=1&selectType=결함&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.DEFECT_FIN}
													</a>
												</td>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=3&selectCondition=&selectTypeState=1&selectType=결함&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.DEFECT_SUM}
													</a>
												</td>
											</tr>
											<tr role="row">
												<th>지원</th>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=1&selectCondition=&selectTypeState=1&selectType=지원&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.SUPPORT_ING}
													</a>
												</td>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=2&selectCondition=&selectTypeState=1&selectType=지원&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.SUPPORT_FIN}
													</a>
												</td>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=3&selectCondition=&selectTypeState=1&selectType=지원&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.SUPPORT_SUM}
													</a>
												</td>
											</tr>
											<tr role="row">
												<th>공지</th>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=1&selectCondition=&selectTypeState=1&selectType=공지&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.NOTICE_ING}
													</a>
												</td>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=2&selectCondition=&selectTypeState=1&selectType=공지&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.NOTICE_FIN}
													</a>
												</td>
												<td>
													<a href="${cp}projectConditionWorkSelect?selectState=3&selectCondition=&selectTypeState=1&selectType=공지&wk_sq=&pro_sq=${sessionScope.projectVo.pro_sq}">
														${sessionScope.countMap.NOTICE_SUM}
													</a>
												</td>
											</tr>
										</tbody>
	                    ...
	                    <div class="tab-pane fade <c:if test="${tabpaneCode == '2'}">active show</c:if>" id="custom-nav-work" role="tabpanel">
	                        ...
	                        <c:forEach items="${workHistoryMapList2}" var="workHistoryMap" varStatus="status">
	                        	...
	                        	<c:choose>
	                        		...
	                        		<c:otherwise>
	                        			<c:if test="${fn:substring(workHistoryMapList2[status.index-1].HIS_DT, 0, 10) != fn:substring(workHistoryMapList2[status.index].HIS_DT, 0, 10)}">
				                        	<h3><fmt:formatDate value="${workHistoryMap.HIS_DT}" pattern="yyyy-MM-dd"/></h3>
	                        			</c:if>
	                        		</c:otherwise>
	                        	</c:choose>
		                        ...
		                        <label style="margin-left:">${workHistoryMap.HIS_CON}</label>
	                    ...
	                    <div class="tab-pane fade <c:if test="${tabpaneCode == '3'}">active show</c:if>" id="custom-nav-condition" role="tabpanel">
	                       	<div class="col col-md-12">
								...
								<div class="col col-md-3">
									<select name="selectState">
										<option <c:if test="${sessionScope.selectState2 == '1'}">selected</c:if> value="1">진행중</option>
										<option <c:if test="${sessionScope.selectState2 == '2'}">selected</c:if> value="2">완료됨</option>
										<option <c:if test="${sessionScope.selectState2 == '3'}">selected</c:if> value="3">모두</option>
									</select>
								</div>
								...
								<div style="float: right;">
									<a href="${cp}/projectWorkInsert?pro_sq=${workHistoryMapList2[0].PRO_SQ}">
										<button type="button" class="btn btn-secondary">업무 등록</button>
									</a>
								</div>
							</div>
							
							<c:forEach items="${sessionScope.selConditionList2}" var="selCondition">
								<c:choose>
										...
										<div class="col col-md-12">
											...
											<div class="col col-md-3">
												<select name="selectProjectState">
													<option <c:if test="${sessionScope.selectProjectState2 == '1'}">selected</c:if> value="1">이다</option>
													<option <c:if test="${sessionScope.selectProjectState2 == '2'}">selected</c:if> value="2">아니다</option>
												</select>
											</div>
											...
											<div class="col col-md-3">
												<select name="selectProject" style="width: 292px;">
													<c:forEach items="${sessionScope.projectList}" var="project">
														<c:if test="${workHistoryMapList2[0].PRO_SQ == project.pro_sq}">
										...
										<div class="col col-md-12">
											...
											<div class="col col-md-3">
												<select name="selectTypeState">
													<option <c:if test="${sessionScope.selectTypeState2 == '1'}">selected</c:if> value="1">이다</option>
													<option <c:if test="${sessionScope.selectTypeState2 == '2'}">selected</c:if> value="2">아니다</option>
												</select>
											</div>
											
											<div class="col col-md-3">
												<select name="selectType" style="width: 292px;">
													<option <c:if test="${sessionScope.wk_type2 == '새기능'}">selected</c:if> value="새기능">새기능</option>
													<option <c:if test="${sessionScope.wk_type2 == '결함'}">selected</c:if> value="결함">결함</option>
													<option <c:if test="${sessionScope.wk_type2 == '지원'}">selected</c:if> value="지원">지원</option>
													<option <c:if test="${sessionScope.wk_type2 == '공지'}">selected</c:if> value="공지">공지</option>
												</select>
											</div>
										</div>
									</c:when>
										...
										<div class="col col-md-12">
											...
											<div class="col col-md-3">
												<select name="selectChargerState">
													<option <c:if test="${sessionScope.selectChargerState2 == '1'}">selected</c:if> value="1">이다</option>
													<option <c:if test="${sessionScope.selectChargerState2 == '2'}">selected</c:if> value="2">아니다</option>
												</select>
											</div>
											
											<div class="col col-md-3">
												<select name="selectCharger" style="width: 292px;">
													<option <c:if test="${sessionScope.wk_emp_sq2 == employee.emp_sq}">selected</c:if> value="${sessionScope.employeeVo.emp_sq}">나</option>
													<c:forEach items="${sessionScope.employeeList}" var="employee">
														<c:if test="${employee.emp_sq != sessionScope.employeeVo.emp_sq}">
															<option <c:if test="${sessionScope.wk_emp_sq2 == employee.emp_sq}">selected</c:if> value="${employee.emp_sq}">${employee.emp_nm}</option>
														</c:if>
													</c:forEach>
												</select>
											</div>
							...
							<div class="col col-md-12">
								<table id="" class="table text-center"
									...
									<tbody>
										...
										<c:forEach items="${sessionScope.workMapList}" var="workMap">
											<c:if test="${workHistoryMapList2[0].PRO_SQ == workMap.PRO_SQ}">
								...
								<input name="pro_sq" type="hidden" value="${sessionScope.projectVo.pro_sq}"/>
											...
											<c:choose>
												<c:when test="${page == '1'}">
													<li class="paginate_button page-item previous disabled" id="bootstrap-data-table_previous">
														<button name="page" tabindex="0" aria-controls="bootstrap-data-table" class="page-link"><i class="fa fa-angle-double-left"></i></button>
													</li>
												</c:when>
												<c:otherwise>
...
<script>
	$(document).ready(function(){
		console.log("${workHistoryMapList2[0].PRO_SQ}");
		...
		$("#btnSelect").on("click", function(){
			//속성바꿀때 사용
			$("#frm").attr("action", "${cp}/projectConditionWorkSelect");
			$("#frm").submit();
		});
		...
		$("#btnDelete").on("click", function(){
			//속성바꿀때 사용
			$("#frm").attr("action", "${cp}/projectConditionDelete");
			$("#frm").submit();
		});
