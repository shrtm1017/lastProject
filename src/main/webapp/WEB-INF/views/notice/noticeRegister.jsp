	...
	<div class="breadcrumbs">
		<div class="col-sm-4">
	        ...
	        <div class="page-title">
	            <h1 style="padding-bottom: 0px;"><strong>게시글 등록</strong></h1>
		        </div>
		    </div>
		</div>
	</div>
	<form id="frm" action="${cp}/notice_register" method="post"
		enctype="multipart/form-data">
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"><br>
			<input type="text" name="ntc_nm" id="ntc_nm" placeholder="제목을 입력하세요."
			...
			<div class="box1" style="float: left">
				...
				<div class="sys-container sys1">
					<button type="button" id="write_btn" class="btn btn-secondary">등록</button>
				...
				.ready(
						function() {
							...
							$("#write_btn")
									.click(
											function() {
												if($("#ntc_nm").val().length==0){alert("제목 입력하세요");$("#ntc_nm").focus(); return false;}
												if (confirm("저장하시겠습니까?")) {
